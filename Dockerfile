...
# 3. Git clone 專案
RUN git clone https://github.com/LeeYenChieh/WebSearchEngine.git
...
0 18 1,16 * * cd /root/WebSearchEngine && /root/system-venv/bin/python3 measure.py --create --metric_db_url ws2.csie.ntu.edu.tw:22215 --crawler_db_url ws2.csie.ntu.edu.tw:22224 --strategy head --keywordNums 1000 --test --measure crawler_all >> /var/log/cron.log 2>&1 \n\
